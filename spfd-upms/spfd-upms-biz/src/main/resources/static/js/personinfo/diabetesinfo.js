...
function initData() {
    $.post("findDiabeteInfoByHealthfileNo", {
        "healthfileNo" : healthfileNo
    }, function(data, status) {
        if (status == "success") {
           $("#diabetesTypeCode").val(data.diabetesTypeCode);
           $("div[data-type='RADIOBX']").each(function() {
               var _this = $(this);
