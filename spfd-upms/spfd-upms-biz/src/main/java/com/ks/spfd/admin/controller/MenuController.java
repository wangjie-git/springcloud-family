...
import com.ks.spfd.admin.service.SysMenuService;
...
public class MenuController {
	...
	public R getUserMenu() {
		...
		List<MenuTree> menuTreeList = all.stream().filter(menuVo -> CommonConstants.MENU.equals(menuVo.getType()))
	...
	public List getRoleTree(@PathVariable Integer roleId) {
		return sysMenuService.findMenuByRoleId(roleId).stream().map(MenuVO::getMenuId).collect(Collectors.toList());
	}
