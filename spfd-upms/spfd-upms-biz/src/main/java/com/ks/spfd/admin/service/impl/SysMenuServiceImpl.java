...
import com.ks.spfd.admin.api.entity.SysRoleMenu;
import com.ks.spfd.admin.api.vo.MenuVO;
import com.ks.spfd.admin.mapper.SysMenuMapper;
import com.ks.spfd.admin.mapper.SysRoleMenuMapper;
...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu> implements SysMenuService {
	...
	public R removeMenuById(Integer id) {
		...
		if (CollUtil.isNotEmpty(menuList)) {
			return new R(CommonConstants.FAIL, "菜单含有下级不能删除");
		}
