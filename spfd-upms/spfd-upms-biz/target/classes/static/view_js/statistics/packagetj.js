...
layui.use([ 'form', 'laydate', 'rate', 'table','tree' ], function() {
 ...
 // 时间选择器
	...
	table.render({
		elem : "#packStastic-table-operate",
		url : "../../packStatistic/queryPackStatistics",
		//url : "../../packStatistic/queryPackStatistics?teamId="+tId,
		cols : [ [ // 标题栏
		 {
			field : 'packName',
			title : '服务包名称'
	...
	var $ = layui.$, active = {
		reload : function() {
			// 执行重载
			table.reload('packStastic-table-operate', {
				page : {
					curr : 1
				// 重新从第 1 页开始
				},
